...
https://github.com/buefy/buefy/blob/06e651912921b758040b996ab8b513c4447b8aa4/src/components/image/Image.vue

<template>
  <figure class="image-wrapper" :class="figureClasses" :style="figureStyles">
    ...
    <transition name="fade">
      <slot v-if="isPlaceholderDisplayed" name="placeholder">
        <img :src="computedPlaceholder" :alt="alt" :class="imgClasses" class="placeholder" />
      </slot>
    </transition>
    ...
    isPlaceholderDisplayed() {
      return (
        ...
        (this.$slots.placeholder ||
          (this.placeholder && (this.webpSupportVerified || !this.isPlaceholderWepb)))
      );
    },
    computedSrcset() {
      if (this.srcset) {
