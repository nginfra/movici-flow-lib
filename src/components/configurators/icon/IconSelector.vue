<template>
  <b-dropdown :value="value" @input="emitIcon" :expanded="expanded">
    <template #trigger>
      <div class="select">
...
export default class IconSelector extends Vue {
  ...
  @Prop({ type: Object, default: () => SOLID_ICONS }) readonly iconOptions!: IconMapping;
  @Prop({ type: Boolean, default: false }) readonly expanded!: boolean;
