import { ActiveEntityLayerSettings, ColorMapLayerSettings, HeatmapLayerSettings, LayerKind, StaticColorLayerSettings, UnknownLayerSettings } from '@/types';
/**
 ...
 */
export function cleanVisualizerSettings(rawSettings) {
