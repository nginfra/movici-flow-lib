...
export declare enum FlowVisualizerType {
    POINTS = "points",
    LINES = "lines",
    POLYGONS = "polygons",
    ARCS = "arcs"
...
export declare type FlowVisualizerOptions = PointVisualizerOptions | LineVisualizerOptions | PolygonVisualizerOptions | ArcVisualizerOptions;
...
declare type SizeUnits = 'pixels' | 'meters';
...
export declare type PopupCallback = (content: PopupContent | null) => void;
