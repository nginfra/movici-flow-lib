...
let FixedPosition = class FixedPosition extends Vue {
    ...
    toggle(force) {
        this.visible = force !== null && force !== void 0 ? force : !this.visible;
        if (this.visible) {
            this.reset();
        }
    }
    ...
    getOverflowVueParent(cssClass, vue_) {
        vue_ !== null && vue_ !== void 0 ? vue_ : (vue_ = this);
        ...
        if ($el === null || $el === void 0 ? void 0 : $el.classList.contains(cssClass)) {
            return vue_;
        }
        else if ($parent) {
    ...
    resetPosition(anchorRect, popupRect, adjust) {
        ...
        if (popupRect && anchorRect) {
            ...
            naturalLeft = anchorRect.left + ((_a = adjust === null || adjust === void 0 ? void 0 : adjust.left) !== null && _a !== void 0 ? _a : 0), naturalTop = anchorRect.top + ((_b = adjust === null || adjust === void 0 ? void 0 : adjust.top) !== null && _b !== void 0 ? _b : 0), 
